...
blade create k8s container-script  execute  --file test.sh --file-args this@A@B@C@is@A@B@C@file@A@B@C@args@A@B@C@string   --names nginx-app --container-ids f1de335b4eeaf --kubeconfig ~/.kube/config --namespace default`)
