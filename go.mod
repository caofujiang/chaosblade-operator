...
replace (
	github.com/chaosblade-io/chaosblade-exec-cri v1.7.3 => github.com/caofujiang/chaosblade-exec-cri v1.8.2
	github.com/chaosblade-io/chaosblade-exec-os v1.7.3 => github.com/caofujiang/chaosblade-exec-os v1.9.11
