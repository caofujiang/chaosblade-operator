...
replace (
	github.com/chaosblade-io/chaosblade-exec-cri v1.7.4 => github.com/caofujiang/chaosblade-exec-cri v1.8.10
	github.com/chaosblade-io/chaosblade-exec-os v1.7.4 => github.com/caofujiang/chaosblade-exec-os v1.9.16
