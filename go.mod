...
replace (
	github.com/chaosblade-io/chaosblade-exec-cri v1.7.0 => github.com/caofujiang/chaosblade-exec-cri v1.7.0
	github.com/chaosblade-io/chaosblade-exec-os v1.7.0 => github.com/caofujiang/chaosblade-exec-os v1.7.0
	github.com/chaosblade-io/chaosblade-spec-go v1.7.0 => github.com/caofujiang/chaosblade-spec-go v1.7.1
